...
}, _client3 = new WeakMap(), _currentResult = new WeakMap(), _currentMutation = new WeakMap(), _mutateOptions = new WeakMap(), _MutationObserver_instances = new WeakSet(), updateResult_fn = function() {
  var _a2;
...
var ve = (n) => {
  ...
  }, [t.closeButton, et]), Tt = o.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = o.useRef(0), U2 = o.useRef(0), St = o.useRef(0), K = o.useRef(null), [Gt, Qt] = st.split("-"), Rt = o.useMemo(() => S.reduce((r2, m, c) => c >= dt ? r2 : r2 + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
...
const CameraOff = createLucideIcon("camera-off", __iconNode$c);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ScanBarcode = createLucideIcon("scan-barcode", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function InfoCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Card,
    {
      className: `shadow-card animate-fade-up border ${isWarning ? "border-warning-border bg-warning-bg" : "border-border bg-card"}`,
      style: { animationDelay: `${delay}ms` },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `mt-0.5 flex-shrink-0 w-9 h-9 rounded-lg flex items-center justify-center ${isWarning ? "bg-warning/20" : "bg-secondary"}`,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h3",
            {
              className: `text-xs font-semibold uppercase tracking-widest mb-1.5 ${isWarning ? "text-warning-foreground" : "text-muted-foreground"}`,
              children: title
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: `text-sm leading-relaxed ${isWarning ? "text-warning-foreground" : "text-foreground"}`,
              children: content
            }
          )
        ] })
...
function MedicineDetail({ info, onBack }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-up", style: { animationDelay: "0ms" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-xl bg-primary flex items-center justify-center flex-shrink-0 pulse-ring", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "w-5 h-5 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground leading-tight truncate", children: info.brandName || "Unknown Medicine" }),
              info.genericName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground truncate", children: info.genericName })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "mt-4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3", children: [
          info.purpose && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
          ...
          info.howToTake && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
          ...
          info.whenToTake && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
          ...
          info.whoShouldTake && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
          ...
          info.warnings && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
          ...
          info.activeIngredients && /* @__PURE__ */ jsxRuntimeExports.jsx(
            InfoCard,
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FlaskConical, { className: "w-4 h-4" }),
        ...
        info.similarMedicines && info.similarMedicines.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Card,
          {
            className: "shadow-card border-border animate-fade-up",
            style: { animationDelay: "420ms" },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-start", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 flex-shrink-0 w-9 h-9 rounded-lg bg-secondary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-3", children: "Similar Medicines" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: info.similarMedicines.map((med, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    "data-ocid": `mediscan.similar.item.${index2 + 1}`,
                    variant: "secondary",
...
function ScannerSection({ onScan, isSearching }) {
  const {
    qrResults,
    isScanning,
    isActive,
  ...
  const lastProcessed = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          !isActive && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-3 bg-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-secondary flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScanBarcode, { className: "w-8 h-8 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-medium", children: isSupported === false ? "Camera not supported on this device" : "Tap below to start scanning" })
          ] }),
          isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-8 h-8 text-primary animate-spin" }) }),
          isActive && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-6 left-6 w-10 h-10 border-l-2 border-t-2 border-primary rounded-tl-sm" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-6 right-6 w-10 h-10 border-r-2 border-t-2 border-primary rounded-tr-sm" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 left-6 w-10 h-10 border-l-2 border-b-2 border-primary rounded-bl-sm" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-6 right-6 w-10 h-10 border-r-2 border-b-2 border-primary rounded-br-sm" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-3 left-0 right-0 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block bg-black/50 text-white text-xs px-3 py-1 rounded-full", children: "Point at barcode" }) })
          ] }),
          error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-2 bg-muted", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CameraOff, { className: "w-8 h-8 text-destructive" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-destructive font-medium px-4 text-center", children: error.message })
          ] })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScanBarcode, { className: "w-4 h-4" }),
          isLoading ? "Initializing camera..." : isActive ? "Stop Scanner" : "Start Barcode Scanner"
        ]
      }
    )
  ] });
}
function parseFdaResult(data, searchTerm) {
  ...
  const r2 = results[0];
  const openfda = r2.openfda || {};
  const brandName = ((_a2 = openfda.brand_name) == null ? void 0 : _a2[0]) || ((_b2 = openfda.substance_name) == null ? void 0 : _b2[0]) || searchTerm || "Unknown";
  const genericName = ((_c2 = openfda.generic_name) == null ? void 0 : _c2[0]) || ((_d2 = openfda.substance_name) == null ? void 0 : _d2[0]) || "";
  const purpose = (((_e2 = r2.purpose) == null ? void 0 : _e2[0]) || ((_f2 = r2.indications_and_usage) == null ? void 0 : _f2[0]) || "").slice(
    0,
    600
  );
  const howToTake = (((_g2 = r2.dosage_and_administration) == null ? void 0 : _g2[0]) || "").slice(0, 600);
  const whenToTake = (((_h2 = r2.when_using) == null ? void 0 : _h2[0]) || ((_i2 = r2.dosage_forms_and_strengths) == null ? void 0 : _i2[0]) || "").slice(0, 400);
  const warnings = (((_j2 = r2.warnings) == null ? void 0 : _j2[0]) || ((_k = r2.warnings_and_cautions) == null ? void 0 : _k[0]) || "").slice(0, 600);
  const whoShouldTake = (((_l = r2.indications_and_usage) == null ? void 0 : _l[0]) || ((_m = r2.contraindications) == null ? void 0 : _m[0]) || "").slice(0, 500);
  const activeIngredients = (((_n = r2.active_ingredient) == null ? void 0 : _n[0]) || "").slice(0, 400);
...
async function fetchFromFDA(url, searchTerm) {
  var _a2;
  const res = await fetch(url);
  const data = await res.json();
  if (!res.ok || data.error) {
    throw new Error(
      ((_a2 = data.error) == null ? void 0 : _a2.message) || "Medicine not found. Please try a different name or scan."
    );
  }
  return parseFdaResult(data, searchTerm);
}
function useSearchByDrugName() {
  return useMutation({
...
function AppContent() {
  ...
  const [view, setView] = reactExports.useState("search");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: "radial-gradient(ellipse 80% 50% at 50% -10%, oklch(0.88 0.07 192 / 0.35), transparent)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "relative sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto px-4 py-3 flex items-center gap-2.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-xl bg-primary flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { className: "w-5 h-5 text-primary-foreground" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground leading-none", children: "MediScan" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-tight", children: "Medicine Information Scanner" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative max-w-lg mx-auto px-4 py-6 pb-16", children: view === "result" && result ? /* @__PURE__ */ jsxRuntimeExports.jsx(MedicineDetail, { info: result, onBack: handleBack }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ScanBarcode, { className: "w-4 h-4 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Scan Barcode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "— Point at medicine packaging" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScannerSection, { onScan: handleScan, isSearching })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "flex-1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium", children: "or search by name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Separator, { className: "flex-1" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 text-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "Search by Drug Name" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleDrugSearch, className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
      ...
      isSearching && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-5 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-5 h-5 text-primary animate-spin flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Looking up medicine..." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Fetching from medical database" })
            ] })
          ] })
        }
      ),
      error && !isSearching && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          "data-ocid": "mediscan.error_state",
          className: "border-destructive/30 bg-destructive/5 animate-fade-in",
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 pb-5 flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "w-5 h-5 text-destructive flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-destructive", children: "Medicine not found" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: error.message || "Please try a different name or scan the barcode again." })
            ] })
          ] })
        }
      ),
      !isSearching && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-2 font-medium", children: "Try searching for:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: [
              ...
              "Lisinopril",
              "Atorvastatin"
            ].map((drug) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-border py-4 mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-lg mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
      "© ",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppContent, {}) });
}
...
const MedicineInfo = Record({
  "whenToTake": Text,
  "warnings": Text,
  "howToTake": Text,
  "genericName": Text,
  "brandName": Text,
  "similarMedicines": Vec(Text),
  "whoShouldTake": Text,
  "purpose": Text,
...
Service({
  "searchByDrugName": Func([Text], [MedicineInfo], []),
  "searchByNdcCode": Func([Text], [MedicineInfo], []),
  "transform": Func(
    [TransformationInput],
