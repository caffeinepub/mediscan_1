...
export class Backend implements backendInterface {
    ...
    async searchByDrugName(arg0: string): Promise<MedicineInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByDrugName(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async searchByNdcCode(arg0: string): Promise<MedicineInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByNdcCode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
